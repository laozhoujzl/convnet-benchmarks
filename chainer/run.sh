...
CHAINER_TYPE_CHECK=0 python -OO train_imagenet.py --arch unet      --batchsize 1       | tee out_unet.log
...
CHAINER_TYPE_CHECK=0 python -OO train_imagenet.py --arch unet      --batchsize 1   -g -1 | tee out_mkl-dnn_cpu_unet.log
